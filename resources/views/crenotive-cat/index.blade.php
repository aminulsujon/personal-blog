...
<!DOCTYPE html>
<html lang="en" class="astro-6MYTB7CN">
    <head>
        <meta charset="UTF-8">
        ...
        <style>@include('crenotive-cat.style')</style>
    ...
    <body class="bg-white dark:bg-gray-900 astro-6MYTB7CN">
        

<header class="crenotive-moderated">
    <nav class="absolute z-10 w-full border-b border-black/5 dark:border-white/5 lg:border-transparent crenotive-moderated">
        <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
    <div class="relative flex flex-wrap items-center justify-between gap-6 py-3 md:gap-0 md:py-4 crenotive-moderated">
                <div class="relative z-20 flex w-full justify-between md:px-0 lg:w-max crenotive-moderated">
                    <a href="/#home" aria-label="logo" class="flex items-center space-x-2 crenotive-moderated">
                        <div aria-hidden="true" class="flex space-x-1 crenotive-moderated">
                            <div class="h-4 w-4 rounded-full bg-gray-900 dark:bg-white crenotive-moderated"></div>
                            <div class="h-6 w-2 bg-primary crenotive-moderated"></div>
                        </div>
                        <span class="text-2xl font-bold text-gray-900 dark:text-white crenotive-moderated">Astrolus</span>
                    </a>

                    <div class="relative flex max-h-10 items-center lg:hidden crenotive-moderated">
                        <button aria-label="humburger" id="hamburger" class="relative -mr-6 p-6 crenotive-moderated">
                            <div aria-hidden="true" id="line" class="m-auto h-0.5 w-5 rounded bg-sky-900 transition duration-300 dark:bg-gray-300 crenotive-moderated"></div>
                            <div aria-hidden="true" id="line2" class="m-auto mt-2 h-0.5 w-5 rounded bg-sky-900 transition duration-300 dark:bg-gray-300 crenotive-moderated"></div>
                        </button>
                    </div>
                </div>
                <div id="navLayer" aria-hidden="true" class="fixed inset-0 z-10 h-screen w-screen origin-bottom scale-y-0 bg-white/70 backdrop-blur-2xl transition duration-500 dark:bg-gray-900/70 lg:hidden crenotive-moderated"></div>
                <div id="navlinks" class="invisible absolute top-full left-0 z-20 w-full origin-top-right translate-y-1 scale-90 flex-col flex-wrap justify-end gap-6 rounded-3xl border border-gray-100 bg-white p-8 opacity-0 shadow-2xl shadow-gray-600/10 transition-all duration-300 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none lg:visible lg:relative lg:flex lg:w-7/12 lg:translate-y-0 lg:scale-100 lg:flex-row lg:items-center lg:gap-0 lg:border-none lg:bg-transparent lg:p-0 lg:opacity-100 lg:shadow-none crenotive-moderated">
                    <div class="w-full text-gray-600 dark:text-gray-200 lg:w-auto lg:pr-4 lg:pt-0 crenotive-moderated">
                        <ul class="flex flex-col gap-6 tracking-wide lg:flex-row lg:gap-0 lg:text-sm crenotive-moderated">
                            <li class="crenotive-moderated">
                                        <a href="/#features" class="hover:text-primary block transition dark:hover:text-white md:px-4 crenotive-moderated">
                                            <span class="crenotive-moderated">Features</span>
                                        </a>
                                    </li><li class="crenotive-moderated">
                                        <a href="/#solution" class="hover:text-primary block transition dark:hover:text-white md:px-4 crenotive-moderated">
                                            <span class="crenotive-moderated">Solution</span>
                                        </a>
                                    </li><li class="crenotive-moderated">
                                        <a href="/#reviews" class="hover:text-primary block transition dark:hover:text-white md:px-4 crenotive-moderated">
                                            <span class="crenotive-moderated">Reviews</span>
                                        </a>
                                    </li>
                            <li class="crenotive-moderated">
                                <a href="https://tailus.gumroad.com/l/astls-premium" target="_blank" class="flex gap-2 font-semibold text-gray-700 transition hover:text-primary dark:text-white dark:hover:text-white md:px-4 crenotive-moderated">
                                    <span class="crenotive-moderated">Premium</span>
                                    <span class="flex rounded-full bg-primary/20 px-1.5 py-0.5 text-xs tracking-wider text-purple-700 dark:bg-white/10 dark:text-orange-300 crenotive-moderated"> new</span>
                                </a>
                            </li>
                        </ul>
                    </div>

                    <div class="mt-12 lg:mt-0 crenotive-moderated">
                        <a href="/register" class="relative flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max crenotive-moderated">
                            <span class="relative text-sm font-semibold text-white crenotive-moderated"> Get Started</span>
                        </a>
                    </div>
                </div>
            </div>
  ...
  <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
    ...
    <div class="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
        ...
        <div class="fixed inset-x-6 bottom-6 z-40 mx-auto w-max astro-6MYTB7CN">
            <a href="https://tailus.gumroad.com/l/astls-premium" target="_blank" class="flex gap-3 rounded-2xl border border-yellow-900/30 bg-gradient-to-br from-white/50 to-yellow-100 p-3 shadow-2xl shadow-yellow-900/50 backdrop-blur-xl dark:border-white/10 dark:from-gray-800 dark:to-black/70 dark:shadow-primary/50 astro-6MYTB7CN">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-600 dark:text-yellow-500 astro-6MYTB7CN">
                    <path fill-rule="evenodd" d="M9 4.5a.75.75 0 01.721.544l.813 2.846a3.75 3.75 0 002.576 2.576l2.846.813a.75.75 0 010 1.442l-2.846.813a3.75 3.75 0 00-2.576 2.576l-.813 2.846a.75.75 0 01-1.442 0l-.813-2.846a3.75 3.75 0 00-2.576-2.576l-2.846-.813a.75.75 0 010-1.442l2.846-.813A3.75 3.75 0 007.466 7.89l.813-2.846A.75.75 0 019 4.5zM18 1.5a.75.75 0 01.728.568l.258 1.036c.236.94.97 1.674 1.91 1.91l1.036.258a.75.75 0 010 1.456l-1.036.258c-.94.236-1.674.97-1.91 1.91l-.258 1.036a.75.75 0 01-1.456 0l-.258-1.036a2.625 2.625 0 00-1.91-1.91l-1.036-.258a.75.75 0 010-1.456l1.036-.258a2.625 2.625 0 001.91-1.91l.258-1.036A.75.75 0 0118 1.5zM16.5 15a.75.75 0 01.712.513l.394 1.183c.15.447.5.799.948.948l1.183.395a.75.75 0 010 1.422l-1.183.395c-.447.15-.799.5-.948.948l-.395 1.183a.75.75 0 01-1.422 0l-.395-1.183a1.5 1.5 0 00-.948-.948l-1.183-.395a.75.75 0 010-1.422l1.183-.395c.447-.15.799-.5.948-.948l.395-1.183A.75.75 0 0116.5 15z" clip-rule="evenodd" class="astro-6MYTB7CN"></path>
                </svg>
                <span class="text-sm font-semibold tracking-wide text-yellow-900 dark:text-white astro-6MYTB7CN"> Upgrade to Premium</span>
            </a>
        </div>
