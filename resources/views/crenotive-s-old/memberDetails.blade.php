                                ...
                                <div class="col-md-12">
                                  <div class="contact-form mt-4">
                                    <form action="https://demo.crenotive.com/contact-store" method="POST">
                                        <input type="hidden" name="_token" value="tVfKlztnOea3M34pKFWYsQp5GZTduznxXAhj8OHt">     
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        //  dd($branches);
                                            ...
                                            <div class="col-md-3 text-center">
                                                <a href="{{ $item->mapLink }}" ><svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
