                ...
                @forelse ($contents as $content)
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-primary" href="{{'http://127.0.0.1:8000/'.$content->upload[0]['file']}}" download>Download File</a> 
                            <a class="btn btn-warning" href="{{'http://127.0.0.1:8000/'.$content->upload[0]['file']}}" target="_blank">View File</a>       
                            @endif
                        </td>
