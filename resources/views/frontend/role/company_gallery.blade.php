...
<section class="section-padding">
    <div class="container">
        <div class="card-body">
            <p class="card-title"> Edit Gallery</p>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="position-relative form-group mb-4 mt-2">
                                    <input name="name" type="text" class="form-control form-control-lg" placeholder="Gallery Title">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row doplicated-fields mb-4">                        
                                <div class="col-md-12">
                                    <div class="border p-2 form-group bg-light">
                                        ...
                                        <input name="name[]" type="text" placeholder="Image Name" class="form-control form-control-lg mb-4">
                                        <textarea name="caption[]" placeholder="Image Caption" class="form-control form-control-lg"></textarea>
                                    </div>
                                </div>
                            </div>
                        @endif
