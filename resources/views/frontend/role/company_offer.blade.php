                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="position-relative form-group mb-4 mt-2">
                                    <input name="name" type="text" class="form-control form-control-lg" placeholder="Offer Title">
                                </div>
                            </div>
                        </div>      
                            ...
                            <div class="row doplicated-fields mb-4">
                                <div class="col-md-12">
                                    <div class="border p-2 form-group bg-light">
                                        ...
                                        <input name="name[]" type="text" placeholder="Offer Name" class="form-control form-control-lg mb-4">
                                        <textarea name="caption[]" placeholder="Offer Caption" class="form-control form-control-lg"></textarea>
                                    </div>
                                </div>
                            </div>
                        @endif
                        <div id="duplicator"></div>         
                        <span id="more-image-button" class="btn btn-success mt-3 mb-3" onclick="duplicate()">Add Another Offer</span><br>
