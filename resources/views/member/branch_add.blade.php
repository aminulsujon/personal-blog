...
<div class="main-card mb-3 card">
    <div class="card-body">
      @if(!empty($member))
      <form class="" action="{{URL::to('member/branch/')}}" method="post" enctype="multipart/form-data">
        @csrf
                  ...
                  @if(!empty($member->branch))
                      @foreach($member->branch as $branch)
                          <div class="row mb-2">
                              ...
                              <div class="col-3">
                                  <a href="{{URL::to('member/branch/edit')}}" title="Edit">
                                      <i class="fa fa-edit"></i>
                                  </a>
                                   <a href="{{URL::to('member/branch/delete/'.$branch->id)}}" title="delete" class="text-danger" onclick="return confirm('Are you sure?')">
