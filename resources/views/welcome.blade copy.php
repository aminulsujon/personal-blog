			...
			<div class="row mb-40">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-headding">
						...
						<p>BCS Computer City Executive Committee List 2022-23</p>
					</div>
				</div>
			</div>
			<div class="row">
	 ...
	 {{-- team ends --}}
		...
		<div class="section-padding-2">
			<div class="container">
				<div class="row">
					<div class="analytics-toll-content">
						<h2 class="text-gradient text-center pt-3 pb-3">Image Gallery</h2>
					</div>				
					<div class="portfolio-category mb-40 text-center">
						<ul>
							<li data-filter="all" class="">All</li>
							<li data-filter=".marketing" class="">City IT Fair</li>
							<li data-filter=".digital" class="">2021</li>
							<li data-filter=".design" class="mixitup-control-active">2022</li>
						</ul>
					</div>
